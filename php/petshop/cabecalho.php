        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="animal/index.php">Animais</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="atendente/index.php">Atendente</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="servico/index.php">Serviço</a>
              </li>
            </ul>
          </div>
        </div>
